...
<div class="container">
    <div class="card">
        <div class="card-body row">
            <div class="col-sm-3">
                <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3" action="{{ route('pagos.index') }}" method="get" role="search">
            ...
            <div class="col-sm-9 d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="button" class="btn btn-small btn-primary small btnFiltro me-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
