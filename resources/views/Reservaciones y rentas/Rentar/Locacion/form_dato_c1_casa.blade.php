...
<form action="{{route('storerentarcasac',[$renta[0]->Id_cliente, $renta[0]->Id_reservacion, $renta[0]->Id_locacion, $renta[0]->Id_lugares_reservados ])}}" method="POST" enctype="multipart/form-data">
@csrf 
@method('PUT')
